    ...
    const handleDeleteItem = () => {
        ...
        if (type === 'remittance') {
            ...
            if (paymentToDelete.remittanceId) {
                toast({ title: "Action Blocked", description: "This payment entry is linked to a 'Revenue Head' remittance and cannot be edited directly. Delete the remittance entry instead.", variant: "destructive" });
