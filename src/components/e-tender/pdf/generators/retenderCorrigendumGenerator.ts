...
export async function generateRetenderCorrigendum(tender: E_tender, corrigendum: Corrigendum, officeAddress: OfficeAddress | null, allStaffMembers?: StaffMember[]): Promise<Uint8Array> {
