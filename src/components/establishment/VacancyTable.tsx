...
import { Edit, Save, PlusCircle, Trash2, Search, FileDown, Loader2, Briefcase, Users, UserMinus } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="bg-blue-50/50 border-blue-200">
                    ...
                    <CardContent>
                        <p className="text-3xl font-bold text-blue-700">{totals.sanctioned}</p>
                    </CardContent>
                </Card>
                <Card className="bg-green-50/50 border-green-200">
                    ...
                    <CardContent>
                        <p className="text-3xl font-bold text-green-700">{totals.current}</p>
                    </CardContent>
                </Card>
                <Card className="bg-red-50/50 border-red-200">
                    ...
                    <CardContent>
                        <p className="text-3xl font-bold text-red-700">{totals.vacancy}</p>
                    </CardContent>
                </Card>
            </div>
