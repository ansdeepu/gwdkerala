...
export default function GWInvestigationPage() {
  ...
  useEffect(() => {
    const description = 'List of all Ground Water Investigation files.';
    setHeader('GW Investigation', description);
  }, [setHeader]);
  ...
  const handleAddNewClick = () => {
    ...
    router.push('/dashboard/data-entry?workType=gwInvestigation');
  };
