...
export default function LoggingPumpingTestPage() {
  ...
  useEffect(() => {
    const description = 'List of all Logging & Pumping Test files.';
    setHeader('Logging & Pumping Test', description);
  }, [setHeader]);
  ...
  const handleAddNewClick = () => {
    ...
    router.push('/dashboard/data-entry?workType=loggingPumpingTest');
  };
